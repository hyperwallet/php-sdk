...
class JOSE_JWT {
    ...
    static function decode($jwt_string) {
        ...
        switch (count($segments)) {
            ...
            case 5:
                ...
                return $jwe;
            default:
                throw new InvalidFormat('JWT should have exact 3 or 5 segments');
        }
    }
    ...
    protected function compact($segment) {
        ...
        if ($stringified === 'null' && $segment !== null) { // shouldn't happen, just for safe
            throw new InvalidFormat('Compact seriarization failed');
        }
    ...
    protected function extract($segment, $as_binary = false) {
        ...
        if ($as_binary) {
            ...
            if ($stringified !== 'null' && $extracted === null) {
                throw new InvalidFormat('Compact de-serialization failed');
            }
        }
        return $extracted;
    }
